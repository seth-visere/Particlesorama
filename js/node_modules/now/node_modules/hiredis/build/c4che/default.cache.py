...
CPPPATH_NODE = '/Users/sethsamuel/local/node/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-Wall', '-O3']
...
LIBDIR = '/Users/sethsamuel/.node_libraries'
LIBPATH_HIREDIS = 'default'
LIBPATH_NODE = '/Users/sethsamuel/local/node/lib'
LIBPATH_ST = '-L%s'
LIB_HIREDIS = 'hiredis'
LIB_ST = '-l%s'
...
LINK_CC = ['/usr/bin/gcc']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/sethsamuel/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/Users/sethsamuel/local/node'
